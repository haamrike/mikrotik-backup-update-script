...
# Updated: 22.08.2020
# Author:  Ivo Ahun
# Website: https://github.com/haamrike/mikrotik-backup-update-script
# You can contact me by e-mail at ivo@kylezone.net
#
# IMPORTANT!
...
:local emailAddress "mingi.epost@domeenimimi.ee";
...
############### ^^^^^^^^^ GLOBALS ^^^^^^^^^ ###############
#Current date time in format: 2020aug20-221324 
